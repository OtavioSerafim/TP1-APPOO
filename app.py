...
app.add_url_rule('/personal', 'personal', UserController.personal)
app.add_url_rule('/personal/alunos', 'alunos-personal', UserController.alunos_personal)
app.add_url_rule('/personal/fichas', 'fichas-personal', UserController.fichas_personal)
app.add_url_rule('/personal/fichas/novo', 'cadastro-ficha-personal', UserController.cadastro_ficha_personal, methods=['GET', 'POST'])
...
app.add_url_rule('/gestor/equipamentos/<int:equipamento_id>/editar', 'atualizar_equipamento', EquipmentController.atualizar, methods=['POST'])
app.add_url_rule('/gestor/equipamentos/<int:equipamento_id>/remover', 'remover_equipamento', EquipmentController.remover, methods=['POST'])
...
app.add_url_rule('/api/fichas/<int:ficha_id>', 'api_ficha', UserController.api_ficha, methods=['GET'])
app.add_url_rule('/gestor/fichas/novo', 'cadastro-ficha-gestor', UserController.cadastro_ficha_gestor, methods=['GET', 'POST'])
